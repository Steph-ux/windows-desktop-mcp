...
_RISK_BY_TOOL_ACTION: dict[tuple[str, str], str] = {
    ...
    ("browser_interact", "click_intent"): "medium",
    ("browser_interact", "suggest_actions"): "read",
    ("browser_interact", "human_idle"): "low",
    ("browser_observe", "observe_rich"): "read",
    ("desktop_interact", "check_actionable"): "read",
    ("desktop_interact", "suggest_actions"): "read",
    ("desktop_interact", "human_idle"): "low",
    ("desktop_observe", "observe_rich"): "read",
